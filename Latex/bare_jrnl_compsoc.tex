...
% \input{Tex/Panorama.tex}
\input{Tex/Motivation.tex}
\input{Tex/Background-Threat.tex}
\input{Tex/Design.tex}
\input{Tex/Implementation.tex}
% \input{Tex/interityforHyperPS.tex}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{IMG/linkunli.jpg}}]{Kunli Lin}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{IMG/liuwenqing.jpg}}]{Wenqing Liu}
  received the master degree in Cyberspace Security from the Institute of Information Engineering, Chinese Academy of Sciences, China, in 2019, and the bachelor degree in Information Security from Tongji University, in 2016. Her primary research interests are in the areas of systems security, with a foucs on trustworthy execution, transportation security, virtualization security and system performance optimization.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{IMG/zhangkun.jpg}}]{Kun Zhang}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{IMG/tubibo.jpg}}]{Bibo Tu}
  is currently a researcher in the Institute of Information Engineering, Chinese Academy of Sciences, and a professor in the School of Cyber Security, University of Chinese Academy of Sciences.  Prior to that, he was an assistant and associate researcher in the Institute of Computing Technology, Chinese Academy of Sciences, China. He received the PhD degree in computer architecture from the Institute of Computing Technology, Chinese Academy of Sciences, China, in 2009, and the master degree in computer software and theory from Huazhong University of Science and Technology, China, in 2002, and the bachelor degree in Computer Science and Technology from Wuhan University of Science and Technology, China, in 1999. His current research interests include trusted computing, software defined security, and dynamic defense technology, etc. 
\end{IEEEbiography}
...
\begin{IEEEbiographynophoto}[\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{IMG/tubibo.png}]{BiBo Tu}
