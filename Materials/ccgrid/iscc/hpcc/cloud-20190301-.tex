...
%of isolating memory among VMs and hypervisor securely by using page marking technique to avoid malicious access from the compromised hypervisor.}
...
%In this section, we focus on monitoring for interaction-data and memory isolation among VMs. 
